  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userSession = {
        ...
        // Decodificamos el token o usamos la info si la API la devuelve (ajustar según backend)
        // Por ahora asumimos que el backend devuelve el token y podemos obtener el perfil luego
        // O mejor, hacemos una llamada a getProfile inmediatamente
      };
